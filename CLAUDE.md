...
| Solution-page pitch framing | Solution pages explain what they do via a health/medical diagnostic analogy rather than purely technical framing. **Shipped for SensWEIGHT** (2026-07-26): new pitch section between hero and Key Features — "vital signs" of the weighbridge/load cells. The other 4 Solution pages (SensSILO/SensGEO/SensATMO/SensGREEN) are held for later — each needs its own analogy-consistent copy, not a copy-paste. |
